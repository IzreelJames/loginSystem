...
<section class="signup-form container">
    ...
    <form action="../signup/signUp-inc.php" method="post"   class="row g-3">
            ...
            <div class="col-md-6">
                <input type="text" name="secondName" class="form-control" placeholder="Last name" aria-label="Last name">
            </div>
        <div class="col-md-6">
            <label for="userEmail" name="email"  class="form-label">Email</label>
            <input type="email" class="form-control" id="userEmail" placeholder="Email address">
        </div>
        <div class="col-md-6">
            <label for="userPassword" name="password"  class="form-label">Password</label>
            <input type="password" class="form-control" id="userPassword" placeholder="password">
        </div>
        <div class="col-12">
            <label for="repeatPassword" name="passwordRepeat"  class="form-label"></label>Repeat Password</label>
